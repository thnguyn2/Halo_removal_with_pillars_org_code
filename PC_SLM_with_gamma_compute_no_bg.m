...
if (inverse)
    ...
    for iteridx = 1:50
        ...
        l = nlcg(gamma_os,l,f,g,params,ao2,as2);
        [obj,term1,term2,term3,term4,term5]=objective_comp(gamma_os,l,f,g,params,ao2,as2);
        disp(['    Updating l: ' num2str(obj), ', #1: ' num2str(term1) ', #2: ' num2str(term2) ...
            ', #3: ' num2str(term3) ', #4: ' num2str(term4), ', #5: ' num2str(term5)]);
        figure(2);
        subplot(131);imagesc(angle(f));colormap gray;colorbar;
        subplot(132);imagesc(angle(g));colormap gray;colorbar;
        subplot(133);imagesc(angle(l));colormap gray;colorbar;drawnow;
        figure(1);
        hold on;
        subplot(132);plot(angle(l(end/2,:)),'r');drawnow;
    end
